"""
Script to execute the migration to create the feature flags table.
"""
...
from migrations.create_features_table import upgrade_sql
...
async def run_migration():
    ...
    print("Starting feature flags table migration...")
